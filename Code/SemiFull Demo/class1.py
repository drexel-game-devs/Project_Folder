import pygame, math
from PythonApplication8 import Bullet
import random
...
class mob(pygame.sprite.Sprite):
    ...
    def sight(self, gameDisplay):
        ...
        pygame.draw.rect(gameDisplay, red_c, (self.rect.x, self.rect.y, 40, 50), 0)
    ...
    def patrol1(self,gameDisplay,player,jumpl,counter,items,bullet_list,active_sprite_list,screen,shot):  

        if self.movement == 'right':
            newcor = player.rect.y + 40
            if player.rect.x in range(self.rect.x-30, self.rect.x + 125) and (player.rect.y in range(self.rect.y-40, self.rect.y + 140) or newcor in range(self.rect.y-60, self.rect.y + 140)):
                shot = 'true'
            ...
            newcor = player.rect.y + 40
            if player.rect.x in range(self.rect.x - 125, self.rect.x+30) and (player.rect.y in range(self.rect.y-40, self.rect.y + 130) or newcor in range(self.rect.y-60, self.rect.y + 140)):
                shot = 'true'
                self.follow1(player,jumpl, counter,items)
